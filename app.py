...
CAMPAIGNS = {
    ...
    'arapahoe': {
        ...
        'map_zoom': 12,
        'county': 'Arapahoe',
        'source_agency': 'Arapahoe County Elections',
        'source_url': 'https://www.arapahoeco.gov/your_county/arapahoevotes/records_data/voter_lists.php',
        'source_site': 'arapahoeco.gov',
    },
    'denverdems': {
...
def make_routes(prefix, cid):
    ...
    def api_config():
        ...
        return jsonify({
            ...
            'sourceAgency': cfg.get('source_agency', 'Denver Elections Division'),
            'sourceUrl': cfg.get('source_url', 'https://www.denvergov.org/Government/Agencies-Departments-Offices/Agencies-Departments-Offices-Directory/Denver-Clerk-and-Recorder/Elections-Division/Election-Data-and-Maps'),
            'sourceSite': cfg.get('source_site', 'denvergov.org'),
